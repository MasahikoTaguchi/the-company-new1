...
class User extends Database{
    ...
    public function login($request){ //このvariableはarray
        ...
        if($result->num_rows == 1){
            ...
            if(password_verify($password,$user['password'])){ //passwordverifyは二つのvariableをとる。この二つがマッチしていれば、TRUE。$user[passwordはencrypted]
    ...
    //retrieve all the records from users table
